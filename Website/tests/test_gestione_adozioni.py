...
from mock import mock_app, mock_alveare, mock_apicoltore, mock_cliente, mock_alveare_non_disponibile
...
def test_inserisci_alveare_tc_2_1(mock_app, mock_apicoltore, mock_alveare):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_apicoltore')
...
def test_inserisci_alveare_tc_2_2(mock_app, mock_apicoltore, mock_alveare):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_apicoltore')
...
def test_inserisci_alveare_tc_2_3(mock_app, mock_apicoltore, mock_alveare):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_apicoltore')
...
def test_inserisci_alveare_tc_2_4(mock_app, mock_apicoltore, mock_alveare):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_apicoltore')
...
def test_inserisci_alveare_tc_2_5(mock_app, mock_apicoltore, mock_alveare):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_apicoltore')
...
def test_inserisci_alveare_tc_2_6(mock_app, mock_apicoltore, mock_alveare):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_apicoltore')
...
def test_inserisci_alveare_tc_2_7(mock_app, mock_apicoltore, mock_alveare):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_apicoltore')
...
def test_adotta_alveare_tc_4_1(mock_app, mock_alveare, mock_cliente):
    with mock_app.app_context(), mock_app.test_client() as test_client:
...
def test_adotta_alveare_tc_4_3(mock_app, mock_alveare_non_disponibile, mock_cliente):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_cliente')
...
def test_adotta_alveare_tc_4_4(mock_app, mock_alveare, mock_cliente):
    with mock_app.app_context(), mock_app.test_client() as test_client:
        test_client.get('/mock_login_cliente')
